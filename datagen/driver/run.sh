...
export HADOOP_CLIENT_OPTS="-Xmx100G"

DEFAULT_HADOOP_HOME=/home/geonho/hadoop-3.2.1 #change to your hadoop folder
...
if [ "$(uname)" == "Darwin" ]; then
  zip -d $LDBC_SNB_DATAGEN_HOME/target/ldbc_snb_datagen-0.3.6-jar-with-dependencies.jar META-INF/LICENSE
fi

$HADOOP_HOME/bin/hadoop jar $LDBC_SNB_DATAGEN_HOME/target/ldbc_snb_datagen-0.3.6-jar-with-dependencies.jar $LDBC_SNB_DATAGEN_HOME/params.ini
